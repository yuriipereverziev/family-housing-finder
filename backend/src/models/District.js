...
//     },
//
//     // Інфраструктура району (кількість об'єктів)
//     infrastructure: {
...
//     },
//
//     // Полігон району (GeoJSON format)
//     // Масив масивів координат [lon, lat]
//     polygon: {
//         type: [[Number]],
//         default: []
//     },
//
//     // Коли створено/оновлено
//     createdAt: {
//         type: Date,
//         default: Date.now
//     },
...
// });
//
// // Унікальний індекс на комбінацію місто + район
// DistrictSchema.index({ city: 1, name: 1 }, { unique: true });
//
// // Автоматично оновлювати updatedAt
